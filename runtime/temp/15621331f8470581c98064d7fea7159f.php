<?php /*a:1:{s:68:"D:\phpstudy_pro\WWW\mine\application\index\view\index\shop_list.html";i:1568192576;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加商品','shop_add',800,600)"><i class="layui-icon"></i>添加</button>
                        </div>
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <a onclick="member_stop(this,<?php echo htmlentities($v['sid']); ?>)" href="javascript:;"  title="下架">
