<?php /*a:1:{s:64:"D:\phpstudy_pro\WWW\mine\application\index\view\index\index.html";i:1568171183;}*/ ?>
<!doctype html>
				...
				<ul id="nav">
					<li>
						...
						<ul class="sub-menu">
							...
							<li>
								<a onclick="xadmin.add_tab('会员列表','member_list')">
									<i class="iconfont">&#xe6a7;</i>
									<cite>会员列表</cite></a>
							</li>
							<!--  <li>
							...
							<li>
								<a onclick="xadmin.add_tab('会员删除','member_del.html')">
									<i class="iconfont">&#xe6a7;</i>
									<cite>会员删除</cite></a>
							</li>
							<!-- 							<li>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a onclick="xadmin.add_tab('待处理订单','order_list')">
									<i class="iconfont">&#xe6a7;</i>
									<cite>待处理订单</cite></a>
							</li>
							<li>
								<a onclick="xadmin.add_tab('待确认订单','order_list2')">
									<i class="iconfont">&#xe6a7;</i>
									<cite>待确认订单</cite></a>
							</li>
							<!--                           <li>
                                <a onclick="xadmin.add_tab('订单列表1','order_list1')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>订单列表1</cite></a>
                            </li> -->
						</ul>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a onclick="xadmin.add_tab('商品列表','shop_list')">
									<i class="iconfont">&#xe6a7;</i>
									<cite>商品列表</cite></a>
							</li>
							<li>
								<a onclick="xadmin.add_tab('下架商品','shop_list1')">
									<i class="iconfont">&#xe6a7;</i>
									<cite>下架商品</cite></a>
							</li>
<!-- 							<li>
					...
					<li>
						<a href="javascript:;">
							<i class="iconfont left-nav-li" lay-tips="Banner管理">&#xe723;</i>
							<cite>Banner管理</cite>
							<i class="iconfont nav_right">&#xe697;</i></a>
						<ul class="sub-menu">
							<li>
								<a onclick="xadmin.add_tab('Banner管理','banner_list')">
									<i class="iconfont">&#xe6a7;</i>
